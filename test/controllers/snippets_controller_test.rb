...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { content: @snippet.content, language: @snippet.language, title: @snippet.title } }
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { content: @snippet.content, language: @snippet.language, title: @snippet.title } }
